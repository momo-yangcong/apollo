...
![delete-app-cluster-namespace-entry](http://localhost:8080/doc/images/delete-app-cluster-namespace-entry.png)

页面详情：

![delete-app-cluster-namespace-detail](http://localhost:8080/doc/images/delete-app-cluster-namespace-detail.png)
