...
![app-id-location](http://localhost:8080/apollo-client/doc/pic/app-id-location.png)
...
![client-local-cache](http://localhost:8080/apollo-client/doc/pic/client-local-cache.png)
...
![text-mode-spring-boot-config-sample](http://localhost:8080/doc/images/text-mode-spring-boot-config-sample.png)
