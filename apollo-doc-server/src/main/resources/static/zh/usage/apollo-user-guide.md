...
![create-app-entry](http://localhost:8080/doc/images/create-app-entry.png)
...
![create-app](http://localhost:8080/doc/images/create-app.png)

4. 点击提交

    创建成功后，会自动跳转到项目首页

![app-created](http://localhost:8080/doc/images/app-created.png)
...
1. 点击页面左侧的“管理项目”
    * ![app-permission-entry](http://localhost:8080/doc/images/app-permission-entry.png)

2. 搜索需要添加的成员并点击添加
    * ![app-permission-search-user](http://localhost:8080/doc/images/app-permission-search-user.png)
    * ![app-permission-user-added](http://localhost:8080/doc/images/app-permission-user-added.png)
...
1. 点击application这个namespace的授权按钮
    * ![namespace-permission-entry](http://localhost:8080/doc/images/namespace-permission-entry.png)

2. 分配修改权限
    * ![namespace-permission-edit](http://localhost:8080/doc/images/namespace-permission-edit.png)

3. 分配发布权限
    * ![namespace-publish-permission](http://localhost:8080/doc/images/namespace-publish-permission.png)
...
1. 点击新增配置
    * ![create-item-entry](http://localhost:8080/doc/images/create-item-entry.png)

2. 输入配置项
    * ![create-item-detail](http://localhost:8080/doc/images/create-item-detail.png)

3. 点击提交
    * ![item-created](http://localhost:8080/doc/images/item-created.png)
...
1. 切换到文本编辑模式
![text-mode-config-overview](http://localhost:8080/doc/images/text-mode-config-overview.png)

2. 点击右侧的修改配置按钮
![text-mode-config-entry](http://localhost:8080/doc/images/text-mode-config-entry.png)

3. 输入配置项，并点击提交修改
![text-mode-config-submit](http://localhost:8080/doc/images/text-mode-config-submit.png)
...
1. 点击“发布按钮”
![publish-entry](http://localhost:8080/doc/images/hermes-portal-publish-entry.png)

2. 填写发布相关信息，点击发布
![publish-detail](http://localhost:8080/doc/images/hermes-portal-publish-detail.png)
...
2. 点击“创建新的Namespace”
    * ![create-namespace-select-type](http://localhost:8080/doc/images/create-namespace-select-type.png)
...
1. 点击新增配置
![public-namespace-edit-item-entry](http://localhost:8080/doc/images/public-namespace-edit-item-entry.png)

2. 输入配置项
![public-namespace-edit-item](http://localhost:8080/doc/images/public-namespace-edit-item.png)

3. 点击提交
![public-namespace-item-created](http://localhost:8080/doc/images/public-namespace-item-created.png)
...
1. 点击“发布按钮”
![public-namespace-publish-items-entry](http://localhost:8080/doc/images/public-namespace-publish-items-entry.png)

2. 填写发布相关信息，点击发布
![public-namespace-publish-items](http://localhost:8080/doc/images/public-namespace-publish-items.png)
...
1. 进入使用公共组件的应用项目首页，点击左侧的添加Namespace按钮
    ...
    * ![link-public-namespace-entry](http://localhost:8080/doc/images/link-public-namespace-entry.png)

2. 找到hermes producer的namespace，并选择需要关联到哪些环境和集群
![link-public-namespace](http://localhost:8080/doc/images/link-public-namespace.png)
...
1. 点击新增配置
![override-public-namespace-entry](http://localhost:8080/doc/images/override-public-namespace-entry.png)

2. 输入要覆盖的配置项
![override-public-namespace-item](http://localhost:8080/doc/images/override-public-namespace-item.png)

3. 点击提交
![override-public-namespace-item-done](http://localhost:8080/doc/images/override-public-namespace-item-done.png)
...
1. 点击“发布按钮”
![override-public-namespace-item-publish-entry](http://localhost:8080/doc/images/override-public-namespace-item-publish-entry.png)

2. 填写发布相关信息，点击发布
![override-public-namespace-item-publish](http://localhost:8080/doc/images/override-public-namespace-item-publish.png)
...
3. 切换到对应的集群，修改配置并发布即可
    * ![config-in-cluster-created](http://localhost:8080/doc/images/cluster-created.png)
...
![initial-instance-list](http://localhost:8080/doc/images/gray-release/initial-instance-list.png)

**灰度目标：**

* 当前有一个配置timeout=2000，我们希望对10.32.21.22灰度发布timeout=3000，对10.32.21.19仍然是timeout=2000。

![initial-config](http://localhost:8080/doc/images/gray-release/initial-config.png)

## 5.2 创建灰度
首先点击application namespace右上角的`创建灰度`按钮。

![create-gray-release](http://localhost:8080/doc/images/gray-release/create-gray-release.png)

点击确定后，灰度版本就创建成功了，页面会自动切换到`灰度版本`Tab。

![initial-gray-release-tab](http://localhost:8080/doc/images/gray-release/initial-gray-release-tab.png)

## 5.3 灰度配置
点击`主版本的配置`中，timeout配置最右侧的`对此配置灰度`按钮

![initial-gray-release-tab](http://localhost:8080/doc/images/gray-release/edit-gray-release-config.png)

在弹出框中填入要灰度的值：3000，点击提交。

![submit-gray-release-config](http://localhost:8080/doc/images/gray-release/submit-gray-release-config.png)

![gray-release-config-submitted](http://localhost:8080/doc/images/gray-release/gray-release-config-submitted.png)

## 5.4 配置灰度规则
切换到`灰度规则`Tab，点击`新增规则`按钮

![new-gray-release-rule](http://localhost:8080/doc/images/gray-release/new-gray-release-rule.png)

在弹出框中`灰度的IP`下拉框会默认展示当前使用配置的机器列表，选择我们要灰度的IP，点击完成。

![select-gray-release-ip](http://localhost:8080/doc/images/gray-release/select-gray-release-ip.png)

![gray-release-ip-selected](http://localhost:8080/doc/images/gray-release/gray-release-ip-selected.png)

![gray-release-rule-saved](http://localhost:8080/doc/images/gray-release/gray-release-rule-saved.png)

如果下拉框中没找到需要的IP，说明机器还没从Apollo取过配置，可以点击手动输入IP来输入，输入完后点击添加按钮

![manual-input-gray-release-ip](http://localhost:8080/doc/images/gray-release/manual-input-gray-release-ip.png)

![manual-input-gray-release-ip-2](http://localhost:8080/doc/images/gray-release/manual-input-gray-release-ip-2.png)
...
![prepare-to-do-gray-release](http://localhost:8080/doc/images/gray-release/prepare-to-do-gray-release.png)

在弹出框中可以看到主版本的值是2000，灰度版本即将发布的值是3000。填入其它信息后，点击发布。

![gray-release-confirm-dialog](http://localhost:8080/doc/images/gray-release/gray-release-confirm-dialog.png)

发布后，切换到`灰度实例列表`Tab，就能看到10.32.21.22已经使用了灰度发布的值。

![gray-release-instance-list](http://localhost:8080/doc/images/gray-release/gray-release-instance-list.png)

切换到`主版本`的`实例列表`，会看到主版本配置只有10.32.21.19在使用了。

![master-branch-instance-list](http://localhost:8080/doc/images/gray-release/master-branch-instance-list.png)
...
![prepare-to-full-release](http://localhost:8080/doc/images/gray-release/prepare-to-full-release.png)

![full-release-confirm-dialog](http://localhost:8080/doc/images/gray-release/full-release-confirm-dialog.png)

![full-release-confirm-dialog-2](http://localhost:8080/doc/images/gray-release/full-release-confirm-dialog-2.png)

我选择了不保留灰度版本，所以发布完的效果就是主版本的配置更新、灰度版本删除。点击主版本的实例列表，可以看到10.32.21.22和10.32.21.19都使用了主版本最新的配置。

![master-branch-instance-list-after-full-release](http://localhost:8080/doc/images/gray-release/master-branch-instance-list-after-full-release.png)

## 5.7 放弃灰度
如果灰度版本不理想或者不需要了，可以点击`放弃灰度`。

![abandon-gray-release](http://localhost:8080/doc/images/gray-release/abandon-gray-release.png)

## 5.8 发布历史
点击主版本的`发布历史`按钮，可以看到当前namespace的主版本以及灰度版本的发布历史。

![view-release-history](http://localhost:8080/doc/images/gray-release/view-release-history.png)

![view-release-history-detail](http://localhost:8080/doc/images/gray-release/view-release-history-detail.png)
