...
![ConfigAdminApplication-Overview](http://localhost:8080/doc/images/local-development/ConfigAdminApplication-Overview.png)

### 2.1.1 新建运行配置
![NewConfiguration-Application](http://localhost:8080/doc/images/local-development/NewConfiguration-Application.png)
...
### 2.1.3 VM options配置
![ConfigAdminApplication-VM-Options](http://localhost:8080/doc/images/local-development/ConfigAdminApplication-VM-Options.png)
...
![ConfigAdminApplication-Run](http://localhost:8080/doc/images/local-development/ConfigAdminApplication-Run.png)

启动完后，打开[http://localhost:8080](http://localhost:8080)可以看到`apollo-configservice`和`apollo-adminservice`都已经启动完成并注册到Eureka。

![ConfigAdminApplication-Eureka](http://localhost:8080/doc/images/local-development/ConfigAdminApplication-Eureka.png)
...
![PortalApplication-Overview](http://localhost:8080/doc/images/local-development/PortalApplication-Overview.png)
...
### 2.2.3 VM options配置
![PortalApplication-VM-Options](http://localhost:8080/doc/images/local-development/PortalApplication-VM-Options.png)
...
![PortalApplication-Run](http://localhost:8080/doc/images/local-development/PortalApplication-Run.png)

启动完后，打开[http://localhost:8070](http://localhost:8070)就可以看到Apollo配置中心界面了。

![PortalApplication-Home](http://localhost:8080/doc/images/local-development/PortalApplication-Home.png)
...
![apollo-demo-app-properties](http://localhost:8080/doc/images/local-development/apollo-demo-app-properties.png)
...
### 2.3.4 VM options配置
![apollo-demo-vm-options](http://localhost:8080/doc/images/local-development/apollo-demo-vm-options.png)
...
![apollo-demo-overview](http://localhost:8080/doc/images/local-development/apollo-demo-overview.png)

### 2.3.6 运行
对新建的运行配置点击Run或Debug皆可。

![apollo-demo-run](http://localhost:8080/doc/images/local-development/apollo-demo-run.png)
...
![apollo-demo-app-config](http://localhost:8080/doc/images/apollo-net-app-config.png)
...
![apollo-net-server-url-config](http://localhost:8080/doc/images/apollo-net-server-url-config.png)
...
# 三、开发
## 模块依赖图
![模块依赖图](http://localhost:8080/doc/images/module-dependency.png)
