...
### 1.4.1 主体E-R Diagram
![apollo-erd](http://localhost:8080/doc/images/apollo-erd.png)
...
![apollo-erd-role-permission](http://localhost:8080/doc/images/apollo-erd-role-permission.png)
...
![release-message-notification-design](http://localhost:8080/doc/images/release-message-notification-design.png)
...
<img src="http://localhost:8080/doc/images/release-message-design.png" alt="release-message-design" width="400px">
...
在运行时的结构形如：
![Overview](http://localhost:8080/doc/images/environment.png)
...
![Overview](http://localhost:8080/doc/images/environment-remote-source.png)
